...
map(
	"n",
	"<leader>fh",
	"<cmd>Telescope find_files theme=ivy previewer=false hidden=true no_ignore=true<cr>",
	"Fuzzy find files in cwd with hidden"
)
...
map(
	...
	"Find string in all open buffers"
)

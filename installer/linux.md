...
If you're on  Windows , see the dedicated guide: [Installer (Windows)](windows.md).


If you're on Android using Termux, see the dedicated guide: [Installer (Termux)](termux.md).

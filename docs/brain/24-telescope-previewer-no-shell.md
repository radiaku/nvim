...
**Rule:** anything in this config that previews/inspects files must use Lua/`vim.loop` or guard the executable, never assume coreutils exist. This is a recurring cross-platform trap. → [[51-windows-pwsh]] · [[50-termux-detection]]
...
Links: [[20-plugin-organization]] · [[51-windows-pwsh]] · [[12-verification]] · [[index]]

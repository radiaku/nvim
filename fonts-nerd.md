# Nerd Font (JetBrainsMono) — Quick Install Guide

Simple, copy‑pasteable commands to install JetBrainsMono Nerd Font on Termux (Android), Linux, and Windows.
...
# Install a single mono regular TTF as Termux font
...
- Use family name `JetBrainsMono Nerd Font` or `JetBrainsMono Nerd Font Mono`.
...
ii "$env:TEMP\JetBrainsMonoNF"
```

Then select the font in your terminal settings (Windows Terminal/Alacritty/WezTerm):
- `JetBrainsMono Nerd Font` or `JetBrainsMono Nerd Font Mono`.

---

## Iosevka Nerd Font (IosevkaTerm) — Quick Install
...
Set the font family to `IosevkaTerm Nerd Font` or `IosevkaTerm Nerd Font Mono` in your terminal.
...
ii "$env:TEMP\IosevkaTermNF"  # Install selected TTFs (Install for all users)
```

Select the font as `IosevkaTerm Nerd Font` or `IosevkaTerm Nerd Font Mono` in Windows Terminal/Alacritty/WezTerm.